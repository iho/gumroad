...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "ExtendedUser.email":
		if e.complexity.ExtendedUser.Email == nil {
			break
		}

		return e.complexity.ExtendedUser.Email(childComplexity), true
	...
	case "Mutation.signup":
		...
		return e.complexity.Mutation.Signup(childComplexity, args["email"].(string), args["password"].(string), args["username"].(string), args["name"].(*string)), true
...
func (ec *executionContext) _ExtendedUser_email(ctx context.Context, field graphql.CollectedField, obj *model.ExtendedUser) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_signup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Signup(rctx, args["email"].(string), args["password"].(string), args["username"].(string), args["name"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _ExtendedUser(ctx context.Context, sel ast.SelectionSet, obj *model.ExtendedUser) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "email":
			out.Values[i] = ec._ExtendedUser_email(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
